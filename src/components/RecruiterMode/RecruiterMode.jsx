...
const RecruiterMode = () => {
  ...
  const metrics = [
    ...
    { label: 'Professional Experience', value: '4', icon: Microscope, description: 'Leadership to Freelance' },
        ...
        >
          <div className="bg-gradient-to-r from-green-600/20 to-blue-600/20 backdrop-blur-md rounded-xl p-8 border border-green-500/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.a
                href={`mailto:${portfolioData.personal.email}?subject=Interview%20Request%20-%20${portfolioData.personal.name}&body=Hi%20${portfolioData.personal.name},%0A%0AI'd%20like%20to%20schedule%20an%20interview%20to%20discuss%20a%20potential%20opportunity.%0A%0ABest%20regards`}
                className="px-8 py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-full font-medium inline-block text-center"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Schedule Interview
